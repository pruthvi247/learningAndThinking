[app-example](https://flutterdesignpatterns.com/pattern/facade)
[source-blogpost](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/)

In the last [article](https://kazlauskas.dev/blog/flutter-design-patterns-6-state/), I analysed one of the behavioural design patterns - State. This time, I would like to represent a pattern that you have probably already used as a developer, but just did not realise that it is a design pattern at all. Therefore, let me introduce you to Facade.
...
## Analysis[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#analysis "Direct link to Analysis")

The general structure of the Facade design pattern looks like this
![[Pasted image 20250210103602.png]]
- _Facade_ - knows which subsystem classes are responsible for a request and delegates the request to _subsystem_ objects. The facade provides methods to access a particular part of the subsystem's functionality;
- _Additional Facade_ - can be created when you want to extract a set of operations from the main facade. This additional facade is optional and could be used by both clients and other facades;
- _Subsystem classes_ - implement subsystem functionality and handle the work assigned by the _Facade_ object. Subsystem classes do not keep references to the facade;
- _Client_ - uses the facade instead of calling the _system classes_ (their objects) directly.
### Applicability[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#applicability "Direct link to Applicability")
...
### Class diagram[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#class-diagram "Direct link to Class diagram")

The class diagram below shows the implementation of the Facade design pattern:
![[Pasted image 20250210103659.png]]
...
### APIs[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#apis "Direct link to APIs")
...
```
### SmartHomeState[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#smarthomestate "Direct link to SmartHomeState")
...
```
### GamingFacade[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#gamingfacade "Direct link to GamingFacade")
...
```
### SmartHomeFacade[​](https://kazlauskas.dev/blog/flutter-design-patterns-7-facade/#smarthomefacade "Direct link to SmartHomeFacade")
